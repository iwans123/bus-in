...
<div class="row mb-4">
    <div class="mb-md-0">
      <div class="card-transparant border border-success">
        <div class="d-flex">
            <div class="my-3 mx-4">
                <a href="/dashboard/keberangkatan/create" class="btn btn-info bg-gradient fw-bold">Add</a>
            </div>
            @hasanyrole('admin')
            <div class="my-3">
                <a href="/dashboard/keberangkatan/exportexcel" class="btn btn-success bg-gradient fw-bold">Export</a>
            </div>
            @endhasanyrole
            <div class="my-3">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center px-2 py-1">
                          <div class="d-flex justify-content-center">
                            <h6 class="mb-0 fw-bold">{{ $keberangkatan->created_at->toDateString() }}</h6>
                          </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center px-2 py-1">
                          <div class="d-flex justify-content-center">
                            <h6 class="mb-0 fw-bold">{{ $keberangkatan->name_po }}</h6>
                          </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center px-2 py-1">
                          <div class="d-flex justify-content-center">
                            <h6 class="mb-0 fw-bold">{{ $keberangkatan->number_vehicle }}</h6>
                          </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center px-2 py-1">
                          <div class="d-flex justify-content-center">
                            <h6 class="mb-0 fw-bold">{{ $keberangkatan->trayek }}</h6>
                          </div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex justify-content-center px-2 py-1">
                          <div class="d-flex justify-content-center">
                            <h6 class="mb-0 fw-bold">{{ $keberangkatan->created_at->toTimeString() }}</h6>
                          </div>
                        </div>
                    </td>
                    <td>
                      <div class="d-flex justify-content-center px-2 py-1">
                        <div class="d-flex justify-content-center">
                          <h6 class="mb-0 fw-bold">{{ $keberangkatan->jumlahPenumpang }}</h6>
                        </div>
                      </div>
                    </td>
                  </tr>
