                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kartu_uji == 'tidak ada')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kartu_uji == 'tidak berlaku')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kartu_uji == 'tidak sesuai fisik')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_reguler == 'ada')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_reguler == 'tidak ada')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_reguler == 'tidak berlaku')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_reguler == 'tidak sesuai fisik')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_cadangan == 'ada')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_cadangan == 'tidak ada')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_cadangan == 'tidak berlaku')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->kp_cadangan == 'tidak sesuai fisik')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->sim_pengemudi == 'A umum')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->sim_pengemudi == 'B umum')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->sim_pengemudi == 'C umum')
                                        checked
                                    @else
                                        disabled
                                    @endif>
                            ...
                            <td class="align-middle text-center">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if ($transaksis[0]->sim_pengemudi == 'sim tidak sesuai')
                                            checked
                                        @else
                                            disabled
                                        @endif>
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <div class="form-check form-check-inline">
                        ...
                        @if ($transaksis[0]->lampuUtama_dekat == 'menyala')
                            checked
                        @else
                            disabled
                        @endif>
                  ...
                  <td class="align-middle">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        @if ($transaksis[0]->lampuUtama_dekat == 'tidak menyala kanan')
                            checked
                        @else
                            disabled
                        @endif>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        @if ($transaksis[0]->lampuUtama_dekat == 'tidak menyala kiri')
                            checked
                        @else
                            disabled
                        @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuUtama_jauh == 'menyala')
                            checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuUtama_jauh == 'tidak menyala kanan')
                            checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuUtama_jauh == 'tidak menyala kiri')
                            checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sein_depan == 'menyala')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sein_depan == 'tidak menyala kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sein_depan == 'tidak menyala kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sein_belakang == 'menyala')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sein_belakang == 'tidak menyala kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sein_belakang == 'tidak menyala kiri')
                                checked
                            @else
                                disabled
                            @endif>
                 ...
                 <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuRem == 'menyala')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuRem == 'tidak menyala kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuRem == 'tidak menyala kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuMundur == 'menyala')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuMundur == 'tidak menyala kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuMundur == 'tidak menyala kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->remUtama == 'berfungsi')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->remUtama == 'tidak berfungsi')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->remParkir == 'berfungsi')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->remParkir == 'tidak berfungsi')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->kaca_depan == 'baik')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->kaca_depan == 'buruk')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pintu_utama == 'berfungsi')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pintu_utama == 'tidak berfungsi kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pintu_utama == 'tidak berfungsi kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->ban_depan == 'laik')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->ban_depan == 'tidak laik kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->ban_depan == 'tidak laik kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->ban_belakang == 'laik')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->ban_belakang == 'tidak laik kanan')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->ban_belakang == 'tidak laik kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sabukPengemudi == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sabukPengemudi == 'tidak fungsi')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->sabukPengemudi == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pengukurKecepatan == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pengukurKecepatan == 'tidak fungsi')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pengukurKecepatan == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->wiper == 'tidak fungsi')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->wiper == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pintuDarurat == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pintuDarurat == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->jendelaDarurat == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->jendelaDarurat == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->alatPemecahkaca == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->alatPemecahkaca == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <div class="form-check form-check-inline">
                        ...
                        @if ($transaksis[0]->lampuPosisi_depan == 'menyala')
                            checked
                        @else
                            disabled
                        @endif>
                  ...
                  <td class="align-middle">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        @if ($transaksis[0]->lampuPosisi_depan == 'tidak menyala kanan')
                            checked
                        @else
                            disabled
                        @endif>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        @if ($transaksis[0]->lampuPosisi_depan == 'tidak menyala kiri')
                            checked
                        @else
                            disabled
                        @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                      <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuPosisi_belakang == 'menyala')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuPosisi_belakang == 'tidak menyala kanan')
                                    checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuPosisi_belakang == 'tidak menyala kiri')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->kacaSpion == 'sesuai')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->kacaSpion == 'tidak sesuai')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->klakson == 'tidak fungsi')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->klakson == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lantaiTangga == 'baik')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lantaiTangga == 'keropos')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->tempatDuduk == 'sesuai')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->tempatDuduk == 'tidak sesuai')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->banCadangan == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->banCadangan == 'tidak laik')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->banCadangan == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->segitigaPengaman == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->segitigaPengaman == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->dongkrak == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pembukaRoda == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->pembukaRoda == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuSenter == 'ada')
                                checked
                            @else
                                disabled
                            @endif>
                    ...
                    <td class="align-middle">
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuSenter == 'tidak fungsi')
                                checked
                            @else
                                disabled
                            @endif>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($transaksis[0]->lampuSenter == 'tidak ada')
                                checked
                            @else
                                disabled
                            @endif>
